...
export const fast = [
  ...
  {
    data: require("./logs/fast/2h34m58.20s_2617355543_spoiler.json"),
    name: "2h34m58.20s_2617355543",
    date: convertDate(2024, 5, 14, 21, 13),
  },
  {
    data: require("./logs/fast/1h41m56.90s_3284600731_spoiler.json"),
  ...
  {
    data: require("./logs/fast/2h21m52.81s_1880739282_spoiler.json"),
    name: "2h21m52.81s_1880739282",
    date: convertDate(2024, 6, 8, 20, 49),
  },
];
